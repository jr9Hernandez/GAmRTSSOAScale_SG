...
public final class ConfigurationsGA {
	public static final int SIZE_CHROMOSOME = 5;
	 ...
	 public static final int SIZE_INVADERS = 4;
	 public static final int K_TOURNMENT = 2;
	 public static final int SIZE_PARENTSFORCROSSOVER = 4;
	 public static final double MUTATION_RATE = 0.4;
	 public static final double MUTATION_RATE_RULE = 0.4;
    ...
    public static final int LOOPS_SELFPLAY = 4;
